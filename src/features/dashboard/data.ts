...
export const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'clients', label: 'StudioHub Clientes', href: '/app/clientes', icon: 'Users' },
  ...
  },
  {
    ...
    label: 'Gestão',
    items: [
      { id: 'payments', label: 'StudioHub Pay', href: '/app/pagamentos', icon: 'CreditCard' },
      {
        id: 'loyalty',
        label: 'StudioHub Marketing',
        href: '/app/fidelizacao',
        icon: 'Gift',
      },
      {
        id: 'reports',
        label: 'StudioHub Finance',
        href: '/app/relatorios',
        icon: 'FileText',
      },
    ],
