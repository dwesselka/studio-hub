...
| -------------- | -------------------------------------------- | ----------------------------------------- |
| `Header`       | `src/ui-components/landing/Header.tsx`       | Navbar com logo, segment switch, CTA      |
| `Hero`         | `src/ui-components/landing/Hero.tsx`         | Hero com toggle salão/barbearia + mock UI |
| `Segments`     | `src/ui-components/landing/Segments.tsx`     | Cards dos segmentos                       |
| `Benefits`     | `src/ui-components/landing/Benefits.tsx`     | Grid de benefícios                        |
| `Testimonials` | `src/ui-components/landing/Testimonials.tsx` | Depoimentos                               |
| `Plans`        | `src/ui-components/landing/Plans.tsx`        | Planos e preços                           |
| `FAQ`          | `src/ui-components/landing/FAQ.tsx`          | Perguntas frequentes                      |
| `CTA`          | `src/ui-components/landing/CTA.tsx`          | Call-to-action final                      |
| `Footer`       | `src/ui-components/landing/Footer.tsx`       | Rodapé                                    |
