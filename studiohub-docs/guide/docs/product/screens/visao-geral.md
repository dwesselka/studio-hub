...
| Tela                                        | Descrição                                             |
| ------------------------------------------- | ----------------------------------------------------- |
| [Landing Page](/product/screens/landing)    | Página institucional com segmentos salão/barbearia    |
| [Dashboard](/product/screens/dashboard)     | Métricas do dia, ocupação, faturamento, agenda do dia |
| [Agenda](/product/screens/agenda)           | Grade de horários, agendamentos, conflitos            |
| [Atendimento](/product/screens/atendimento) | Fila de atendimentos em andamento                     |
| [Clientes](/product/screens/clientes)       | CRUD + busca/filtro de clientes                       |
| [Pagamentos](/product/screens/pagamentos)   | Registro e histórico de pagamentos                    |
