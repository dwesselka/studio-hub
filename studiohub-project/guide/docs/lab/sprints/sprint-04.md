...
Optamos por PostGIS em vez de calcular distâncias no código (Haversine formula) para aproveitar índices espaciais nativos do PostgreSQL e queries nativas em SQL. [→ Ver ADR completo](/lab/adrs/)
:::
...
- [→ Roadmap](/lab/roadmap)
- [→ Architecture Review: Geolocalização](/lab/arch-reviews/ar-geolocation)
- [→ ADRs relacionados](/lab/adrs/)
